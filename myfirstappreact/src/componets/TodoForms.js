...
class TodoForms extends Component {
    ...
    handleInput(e) {
        ...
        //Set state  es un evento para cambiar los datos del estado
        ...
        return (
            <div className="card">
                <form onSubmit={this.handleSubmit} className="card-body">
                    ...
                    <div className="form-group">
                        <input type="responsible" name="responsible" className="form-control"
                            placeholder="Responsible" onChange={this.handleInput} />
                    </div>
                    <div className="form-group">
